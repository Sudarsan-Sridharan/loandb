...
public class CrudTest extends AbstractTest {
    ...
    public void testCRUD() {
        ...
        applicant1.setEmailAddress("ken@customer.com");
        applicant1.setGenderType(GenderType.MALE);
        applicant1.setIdentificationNumber("1234567890");
        applicant1.setIdentificationAuthority("DOT");
        applicant1.setIdentificationType(IdentificationType.LICENSE);
        try {
            applicant1.setIdentificationIssueDate(dateFormat.parse("07/11/2007"));
            applicant1.setIdentificationExpirationDate(dateFormat.parse("07/11/2012"));
        } catch (ParseException e) {
            e.printStackTrace();
        }
        applicant1.setPhoneNumber("123-456-7890");
        applicant1.setPhoneType(PhoneType.HOME);
        ...
        applicant2Primary.setEmailAddress("alan@applicant.com");
        applicant2Primary.setGenderType(GenderType.MALE);
        applicant2Primary.setIdentificationNumber("1234567890");
        applicant2Primary.setIdentificationAuthority("DOT");
        applicant2Primary.setIdentificationType(IdentificationType.LICENSE);
        try {
            applicant2Primary.setIdentificationIssueDate(dateFormat.parse("07/11/2007"));
            applicant2Primary.setIdentificationExpirationDate(dateFormat.parse("07/11/2012"));
        } catch (ParseException e) {
            e.printStackTrace();
        }
        applicant2Primary.setPhoneNumber("123-456-7890");
        applicant2Primary.setPhoneType(PhoneType.HOME);
        ...
        applicant2Secondary.setEmailAddress("alan@applicant.com");
        applicant2Secondary.setGenderType(GenderType.MALE);
        applicant2Secondary.setIdentificationNumber("1234567890");
        applicant2Secondary.setIdentificationAuthority("DOT");
        applicant2Secondary.setIdentificationType(IdentificationType.LICENSE);
        try {
            applicant2Secondary.setIdentificationIssueDate(dateFormat.parse("07/11/2007"));
            applicant2Secondary.setIdentificationExpirationDate(dateFormat.parse("07/11/2012"));
        } catch (ParseException e) {
            e.printStackTrace();
        }
        applicant2Secondary.setPhoneNumber("123-456-7890");
        applicant2Secondary.setPhoneType(PhoneType.HOME);
        ...
        applicant3.setEmailAddress("alan@applicant.com");
        applicant3.setGenderType(GenderType.MALE);
        applicant3.setIdentificationNumber("1234567890");
        applicant3.setIdentificationAuthority("DOT");
        applicant3.setIdentificationType(IdentificationType.LICENSE);
        try {
            applicant3.setIdentificationIssueDate(dateFormat.parse("07/11/2007"));
            applicant3.setIdentificationExpirationDate(dateFormat.parse("07/11/2012"));
        } catch (ParseException e) {
            e.printStackTrace();
        }
