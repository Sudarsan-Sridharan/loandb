 ...
 * {@link org.loandb.persistence.util.EntityPruner}.  Entities must be pruned before they can be Serialized
 ...
 * matter what the data type is, because the {@link org.loandb.persistence.util.EntityPruner} only needs to
 * know if the entity has an id or not.  The default value in an entity should
 * be null, to indicate no database identity.
 * <p/>
 * The pruned attribute is used by the {@link org.loandb.persistence.util.EntityPruner} to determine if
